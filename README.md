...
- browser and MCP surfaces expose retrieval, cited context, lifecycle history, metadata curation, and reprocess requests while `orchestrator` keeps workflow ownership
