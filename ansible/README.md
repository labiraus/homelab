...
- `atm11` is the repo-authoritative active profile and is pinned with `CF_SLUG=all-the-mods-11`, `CF_FILENAME_MATCHER=0.0.16`, `NEOFORGE_VERSION=26.1.2.43-beta`, and `start_mode=preinstalled_run_script`
...
Example for `atm11` moving from `0.0.5` to `0.0.16`:
