...
- `GET /mcp` opens the server-to-client SSE stream for that session and only emits real JSON-RPC messages or keepalive comments, not synthetic empty `data:` events
